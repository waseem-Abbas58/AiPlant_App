...
class OnboardingCarePage extends StatefulWidget {
  const OnboardingCarePage({
    super.key,
    this.data = OnboardingModel.plantCareReminders,
  });

  final OnboardingModel data;

  @override
  State<OnboardingCarePage> createState() => _OnboardingCarePageState();
}

class _OnboardingCarePageState extends State<OnboardingCarePage>

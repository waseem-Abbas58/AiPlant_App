...
class OnboardingGardenPage extends StatefulWidget {
  const OnboardingGardenPage({
    super.key,
    this.data = OnboardingModel.myGarden,
  });

  final OnboardingModel data;

  @override
  State<OnboardingGardenPage> createState() => _OnboardingGardenPageState();
}

class _OnboardingGardenPageState extends State<OnboardingGardenPage>

...
class OnboardingIdentifyPage extends StatefulWidget {
  const OnboardingIdentifyPage({
    super.key,
    this.data = OnboardingModel.identifyPlant,
  });

  final OnboardingModel data;

  @override
  State<OnboardingIdentifyPage> createState() => _OnboardingIdentifyPageState();
}

class _OnboardingIdentifyPageState extends State<OnboardingIdentifyPage>
